...
exports.RefundModule = RefundModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([refund_model_1.RefundModel, agent_model_1.AgentModel, booking_model_1.BookingModel, admin_model_1.AdminModel, admin_model_1.AdminModel, staff_model_1.StaffModel, report_model_1.AgentLedgerModel, auth_model_1.OTPModel])],
        controllers: [refund_controller_1.RefundController],
        providers: [refund_service_1.RefundService, auth_service_1.AuthService, auth_utils_1.AuthUtils, jwt_1.JwtService, mail_service_1.MailService],
    })
], RefundModule);
