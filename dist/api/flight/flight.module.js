...
exports.FlightModule = FlightModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([airlines_model_1.AirlinesModel, airlines_model_1.AirlineDiscount, airlines_model_1.AirlineDiscountForAgent, searchhistory_model_1.SearchHistoryModel, groupfare_model_1.GroupFareModel, traveller_model_1.TravellerModel, ticketing_model_1.TicketModel, airports_model_1.AirportsModel,
                ...
                report_model_1.AgentLedgerModel, auth_model_1.OTPModel, currency_entity_1.CurrencyConverter, save_flight_entity_1.SaveFlightsData])
        ],
        ...
        providers: [
            ...
            searchhistory_service_1.SearchhistoryService, auth_utils_1.AuthUtils, alhind_flights_service_1.AlhindAPI
        ]
    })
], FlightModule);
