...
export declare class TicketingService {
    ...
    constructor(agentRepository: Repository<AgentModel>, agentLedgerRepository: Repository<AgentLedgerModel>, ticketingRepository: Repository<TicketModel>, bookingRepository: Repository<BookingModel>, passengerRepository: Repository<PassengerModel>, mailService: MailService, authService: AuthService);
