...
exports.TicketingModule = TicketingModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([agent_model_1.AgentModel, partialpayment_entity_1.PartialPaymentModel, passenger_model_1.PassengerModel, ticketing_model_1.TicketModel, report_model_1.AgentLedgerModel, admin_model_1.AdminModel, booking_model_1.BookingModel, staff_model_1.StaffModel, auth_model_1.OTPModel, activitylog_entity_1.ActivityLogModel])],
        controllers: [ticketing_controller_1.TicketingController],
        providers: [ticketing_service_1.TicketingService, partialpayment_service_1.PartialpaymentService, auth_service_1.AuthService, jwt_1.JwtService, auth_utils_1.AuthUtils, mail_service_1.MailService, activitylog_service_1.ActivitylogService],
    })
], TicketingModule);
